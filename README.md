...
|| **Frontend** | **Backend**                                                                                                                                                                                                             |
|------|-----------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Installation** | 1- ```cd frontend```</br>2- ```npm install```</br></br> | **Create virtual environment** </br>1- ```cd backend```</br>2- ```python -m venv .venv```</br></br> **Install Python dependencies** </br>1- ```cd backend```</br>2- ```pip install -r requirements.txt```</br></br> |
