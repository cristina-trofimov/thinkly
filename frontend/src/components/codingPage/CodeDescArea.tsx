...
const SubmissionResultSkeleton = () => (
...
const SubmissionResult = ({ result }: { result: SubmissionType }) => {
                ...
                <div className="space-y-4">
                    ...
                    <div className="bg-muted/30 rounded-lg p-4 space-y-3">
                        <div className="flex justify-between items-center">
                            ...
                            <span className="font-mono font-medium">{result.runtime ?? "—"} ms</span>
                        </div>
                        <div className="flex justify-between items-center">
                            <span className="text-muted-foreground">Memory</span>
                            <span className="font-mono font-medium">{result.memory ?? "—"} KB</span>
                        </div>
                        <div className="flex justify-between items-center">
                    ...
                    <div className="flex flex-col gap-4">
                        {result.stdout && (
                            <div className="bg-muted/30 rounded-lg p-4">
                                ...
                                <pre className="font-mono text-sm bg-background p-3 rounded border overflow-auto max-h-64">
                                    {result.stdout}
                                </pre>
                            </div>
                        )}
                        {result.stderr && (
                            <div className="bg-muted/30 rounded-lg p-4">
                                ...
                                <pre className="font-mono text-sm bg-red-500/5 text-red-600 dark:text-red-400 p-3 rounded border border-red-200 dark:border-red-900 overflow-auto max-h-64">
                                    {result.stderr}
                                </pre>
                            </div>
                        )}
