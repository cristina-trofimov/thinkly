...
describe("Code Submission", () => {
  ...
  it("processes submission not linked to an event (practice question)", async () => {
    await submitAttempt(mockQuestionInstance, user_id, undefined, source_code, language_id, testcases)
  ...
  it("processes submission linked to an event", async () => {
    await submitAttempt(mockQuestionInstance, user_id, event_id, source_code, language_id, testcases)
  ...
  it("handles errors from Judge0 API", async () => {
    ...
    await expect(submitAttempt(mockQuestionInstance, user_id, undefined, source_code, language_id, testcases))
