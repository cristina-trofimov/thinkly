...
from endpoints import send_email
...
class TestEmailEndpoints:
    ...
    @patch('endpoints.send_email.validate_email')
    @patch('endpoints.send_email.requests.post')
...
class TestNormalizeIsoUtc:
    ...
    def test_normalize_iso_utc_with_z_suffix(self):
        ...
        from endpoints.send_email import normalize_iso_utc
